...
var Corner = {
	...
	*/
	...
	//2d segment intersection code that works. Backup in case math.js intersection turns out
	// to be buggy.
	// code taken from https://gist.github.com/gordonwoodhull/50eb65d2f048789f9558
	//
	// eps: 0.0000001,
	// between(a, b, c) {
	// 	return a - Corner.eps <= b && b <= c + Corner.eps;
	// },
	...
	// 	} else {
	// 		if (x1 >= x2) {
	// 			if (!Corner.between(x2, x, x1)) {
	// 				return false;
	// 			}
	// 		} else {
	// 			if (!Corner.between(x1, x, x2)) {
	// 				return false;
	// 			}
	// 		}
	// 		if (y1 >= y2) {
	// 			if (!Corner.between(y2, y, y1)) {
	// 				return false;
	// 			}
	// 		} else {
	// 			if (!Corner.between(y1, y, y2)) {
	// 				return false;
	// 			}
	// 		}
	// 		if (x3 >= x4) {
	// 			if (!Corner.between(x4, x, x3)) {
	// 				return false;
	// 			}
	// 		} else {
	// 			if (!Corner.between(x3, x, x4)) {
	// 				return false;
	// 			}
	// 		}
	// 		if (y3 >= y4) {
	// 			if (!Corner.between(y4, y, y3)) {
	// 				return false;
	// 			}
	// 		} else {
	// 			if (!Corner.between(y3, y, y4)) {
	// 				return false;
	// 			}
	// 		}
	// 	}
